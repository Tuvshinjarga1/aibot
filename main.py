...
def is_follow_up_question(thread_id, current_message):
    """Өмнөх асуудалтай шууд холбоотой асуулт мөн эсэхийг шалгах"""
    try:
        ...
        # AI-аар шууд холбоотой эсэхийг шалгах (илүү хатуу шалгуур)
        system_msg = (
            "Та бол чат дүн шинжилгээний мэргэжилтэн. "
            "Хэрэглэгчийн сүүлийн мессеж нь өмнөх асуудлын ШУУД үргэлжлэл мөн эсэхийг тодорхойлно уу. "
            "Зөвхөн тодруулга, нэмэлт мэдээлэл хүсэх, эсвэл ижил асуудлын талаар гомдол гэх мэт "
            "ШУУД холбоотой асуултыг 'ШУУД_ХОЛБООТОЙ' гэж тэмдэглэнэ үү. "
            "Ижил төстэй боловч өөр асуулт бол 'ШИНЭ_АСУУДАЛ' гэж тэмдэглэнэ үү."
        )
...
- "ШИНЭ_АСУУДАЛ" - хэрэв одоогийн мессеж өмнөхтэй огт холбоогүй эсвэл ижил төстэй боловч өөр асуудал бол
- "ШУУД_ХОЛБООТОЙ" - хэрэв өмнөх асуудлын тодруулга, нэмэлт мэдээлэл хүсэх, гомдол гэх мэт ШУУД үргэлжлэл бол

Жишээ нь:
- "Энэ асуудал хэзээ шийдэгдэх вэ?" → ШУУД_ХОЛБООТОЙ
- "Яагаад ийм удаан байна вэ?" → ШУУД_ХОЛБООТОЙ  
- "API хэрхэн ашиглах вэ?" (өмнө нь өөр API-н тухай асуусан) → ШИНЭ_АСУУДАЛ
- "Документ хаана байна вэ?" (өмнө нь өөр документ хайсан) → ШИНЭ_АСУУДАЛ
'''
        ...
        if "ШУУД_ХОЛБООТОЙ" in analysis_result:
            return True, "Өмнөх асуудлын шууд үргэлжлэл - Teams-д шилжүүлнэ"
        else:
            return False, "Шинэ эсвэл ижил төстэй асуудал - RAG ашиглана"
