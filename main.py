...
def get_ai_response(user_message: str, conversation_id: int, context_data: list = None):
    ...
    Хэрэглэгчийг тавтай морилохдоо найрсаг, тусламж санал болгохуйц байр суурь авна уу:
    - Энгийн мэндчилгэн ("Сайн байна уу", "Сайн уу", "Hello") эсвэл тусламжийн хүсэлтэд "Сайн байна уу! Би таньд туслахад бэлэн байна" гэж хариулна уу
    - Зөвхөн баримт бичгийн асуултад л дэлгэрэнгүй хариулт өгнө үү
    - Найрсаг, тусламжийн сэтгэлгээтэй байна уу
