...
2. **Систем шинэ асуудал эсэхийг шалгах** → Хэрэв шинэ асуудал бол дүгнэх
3. **AI бүх чат түүхийг харж дүгнэлт хийх** → Teams-д илгээх
4. **Ажилтан Teams дээр дүгнэлт харах** → Тохирох арга хэмжээ авах

### Ухаалаг мэдээлэх систем:

- ✅ **Анхны асуулт** → Заавал Teams-д илгээх
- ✅ **Шинэ төрлийн асуудал** → Teams-д илгээх
- ❌ **Дагалдах асуулт** → Teams-д илгээхгүй
- ❌ **Ижил асуудлын давтамж** → Teams-д илгээхгүй
